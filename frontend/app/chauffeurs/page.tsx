    ...
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen">
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        <div className="lg:w-1/2">
          <span className="text-emerald-500 uppercase tracking-widest text-sm font-semibold">The Elite Professionals Behind the Wheel</span>
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mt-4 mb-6">Our Chauffeurs</h1>
          <p className="text-silver-400 leading-relaxed text-lg mb-8">
            At 95 Star, our chauffeurs are the face of our brand. We hire only the top 1% of applicants. Each chauffeur undergoes rigorous background checks, defensive driving courses, and hospitality training to deliver an impeccable, white-glove service experience.
          </p>
        ...
        <div className="lg:w-1/2 w-full">
          <div className="glass-card overflow-hidden p-2 rounded-2xl">
            <div className="w-full h-[400px] bg-cover bg-center rounded-xl" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?q=80&w=2070&auto=format&fit=crop')" }}></div>
          </div>
        </div>
      </div>
