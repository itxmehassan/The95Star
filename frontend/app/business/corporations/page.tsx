    ...
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen">
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        <div className="lg:w-1/2">
          <span className="text-emerald-500 uppercase tracking-widest text-sm font-semibold">Streamlined Executive Transport</span>
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mt-4 mb-6">For Corporations</h1>
          <p className="text-silver-400 leading-relaxed text-lg mb-8">
            Partner with 95 Star to manage all your executive transportation needs. Enjoy monthly invoicing, detailed reporting, and a custom booking portal for your administrative staff. Ensure your executives and VIP clients receive the highest standard of care.
          </p>
        ...
        <div className="lg:w-1/2 w-full">
          <div className="glass-card overflow-hidden p-2 rounded-2xl">
            <div className="w-full h-[400px] bg-cover bg-center rounded-xl" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=2069&auto=format&fit=crop')" }}></div>
          </div>
        </div>
      </div>
