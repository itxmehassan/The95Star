    ...
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen">
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        <div className="lg:w-1/2">
          <span className="text-emerald-500 uppercase tracking-widest text-sm font-semibold">Elevating Corporate Mobility</span>
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mt-4 mb-6">Business Overview</h1>
          <p className="text-silver-400 leading-relaxed text-lg mb-8">
            95 Star Chauffeur provides comprehensive corporate mobility solutions. We understand the demands of modern business. Our platform offers centralized billing, dedicated account managers, and priority booking to ensure your team always travels in style and on time.
          </p>
        ...
        <div className="lg:w-1/2 w-full">
          <div className="glass-card overflow-hidden p-2 rounded-2xl">
            <div className="w-full h-[400px] bg-cover bg-center rounded-xl" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=2070&auto=format&fit=crop')" }}></div>
          </div>
        </div>
      </div>
