    ...
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen">
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        <div className="lg:w-1/2">
          <span className="text-emerald-500 uppercase tracking-widest text-sm font-semibold">Mutually Beneficial Alliances</span>
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mt-4 mb-6">Strategic Partnerships</h1>
          <p className="text-silver-400 leading-relaxed text-lg mb-8">
            95 Star collaborates with luxury hotels, premium event planners, and private aviation companies to offer integrated, end-to-end luxury experiences. Contact our partnership team to explore co-branding and exclusive service agreements.
          </p>
        ...
        <div className="lg:w-1/2 w-full">
          <div className="glass-card overflow-hidden p-2 rounded-2xl">
            <div className="w-full h-[400px] bg-cover bg-center rounded-xl" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1563720225384-9c0f679246d8?q=80&w=2070&auto=format&fit=crop')" }}></div>
          </div>
        </div>
      </div>
