    ...
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen">
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        <div className="lg:w-1/2">
          <span className="text-emerald-500 uppercase tracking-widest text-sm font-semibold">Punctual & Stress-Free</span>
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mt-4 mb-6">Airport Transfer</h1>
          <p className="text-silver-400 leading-relaxed text-lg mb-8">
            Our premium airport transfer service guarantees you will never miss a flight or wait in line for a taxi. We offer complimentary flight tracking, meet & greet services at the arrivals hall, and assistance with your luggage. Start or end your journey with unparalleled comfort.
          </p>
