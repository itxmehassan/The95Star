    ...
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen">
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        <div className="lg:w-1/2">
          <span className="text-emerald-500 uppercase tracking-widest text-sm font-semibold">Executive Protection & Professionalism</span>
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mt-4 mb-6">Chauffeur Service</h1>
          <p className="text-silver-400 leading-relaxed text-lg mb-8">
            Our highly trained chauffeurs offer more than just driving. With backgrounds in executive protection and defensive driving, they provide a safe, secure, and highly discreet environment for high-net-worth individuals and corporate executives.
          </p>
