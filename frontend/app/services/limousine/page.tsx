    ...
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen">
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        <div className="lg:w-1/2">
          <span className="text-emerald-500 uppercase tracking-widest text-sm font-semibold">Arrive in Unforgettable Style</span>
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mt-4 mb-6">Limousine Service</h1>
          <p className="text-silver-400 leading-relaxed text-lg mb-8">
            Make your special occasion truly memorable with our premium stretch limousine services. From weddings and proms to red-carpet events and VIP nights out, our limousines offer complimentary beverages, mood lighting, and privacy partitions.
          </p>
        ...
        <div className="lg:w-1/2 w-full">
          <div className="glass-card overflow-hidden p-2 rounded-2xl">
            <div className="w-full h-[400px] bg-cover bg-center rounded-xl" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1549428587-8fbaf5c1f516?q=80&w=2070&auto=format&fit=crop')" }}></div>
          </div>
        </div>
      </div>
