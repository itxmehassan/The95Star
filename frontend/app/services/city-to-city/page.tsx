    ...
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen">
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        <div className="lg:w-1/2">
          <span className="text-emerald-500 uppercase tracking-widest text-sm font-semibold">Seamless Long-Distance Travel</span>
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mt-4 mb-6">City to City Rides</h1>
          <p className="text-silver-400 leading-relaxed text-lg mb-8">
            Experience seamless, comfortable intercity travel with 95 Star. Bypass the hassle of airports and train stations. Our chauffeurs will pick you up from your doorstep and drive you directly to your destination in ultimate luxury and privacy. Perfect for both business executives and families.
          </p>
        ...
        <div className="lg:w-1/2 w-full">
          <div className="glass-card overflow-hidden p-2 rounded-2xl">
            <div className="w-full h-[400px] bg-cover bg-center rounded-xl" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?q=80&w=2070&auto=format&fit=crop')" }}></div>
          </div>
        </div>
      </div>
